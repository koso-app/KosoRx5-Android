...
class StaticMapFragment : Fragment() {
    ...
    private val responseListener = Response.Listener<Bitmap> {
        ...
        val perSize = vSize.text.toString().toInt()
        val cmds = StaticMapCommand.createFromBytes(bytes, perSize)
